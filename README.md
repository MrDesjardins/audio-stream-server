...
- **TRANSCRIPTION_PROVIDER**:
  - `openai` = Whisper API ($0.006/minute, very accurate, fast)
  - `gemini` = Gemini 1.5 Flash (free tier available, good quality)
...
- OpenAI Whisper: tokens × audio duration minutes × $0.006
